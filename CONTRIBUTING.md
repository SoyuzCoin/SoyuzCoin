Contributing to Soyuz3 Core
============================

The Soyuz3 Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Soyuz3 Core project, and is not to be
confused with overall Soyuz3 Network Protocol consensus changes.

Whether a pull request is merged into Soyuz3 Core rests with the project merge
...
Patches that change Soyuz3 consensus rules are considerably more involved than
...
Where a patch set proposes to change the Soyuz3 consensus, it must have been
...
The project leader is the release manager for each Soyuz3 Core release.
