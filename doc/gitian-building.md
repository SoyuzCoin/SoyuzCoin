...
*Setup instructions for a gitian build of Soyuz3 using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Soyuz3
...
- [Building Soyuz3](#building-soyuz3)
...
Clone the git repositories for soyuz3 and gitian and then checkout the soyuz3 version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/soyuz3-crypto/soyuz3.git
cd soyuz3
...
Follow the instructions in [doc/release-process.md](release-process.md) in the soyuz3 repository
...
To build Soyuz3 (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the soyuz3 repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/soyuz3/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/soyuz3-crypto/soyuz3
...
For example:
```bash
URL=https://github.com/crowning-/soyuz3.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit soyuz3=${COMMIT} --url soyuz3=${URL} ../Soyuz3/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit soyuz3=${COMMIT} --url soyuz3=${URL} ../Soyuz3/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit soyuz3=${COMMIT} --url soyuz3=${URL} ../Soyuz3/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/soyuz3-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/soyuz3-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/soyuz3-build.assert
```
...
[soyuz3/gitian.sigs](https://github.com/soyuz3-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
