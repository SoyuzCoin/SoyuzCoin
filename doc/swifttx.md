...
This mechanism has been integrated into Bitcore-Node-Soyuz3 which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Soyuz3-Project/insight-api-soyuz3#web-socket-api](https://github.com/Soyuz3-Project/insight-api-soyuz3#web-socket-api) 
* API: [https://github.com/Soyuz3-Project/insight-api-soyuz3#swifttx-transactions](https://github.com/Soyuz3-Project/insight-api-soyuz3#swifttx-transactions) 
...
By default, the Soyuz3 Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Soyuz3 Core daemon:
