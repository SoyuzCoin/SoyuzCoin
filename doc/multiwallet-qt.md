...
In order to support loading of multiple wallets in soyuz3-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is soyuz3.cpp.
...
Changes to soyuz3.cpp
----------------------
soyuz3.cpp is the entry point into soyuz3-qt, and as such, will require some minor modifications to provide hooks for
