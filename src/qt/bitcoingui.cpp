                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Soyuz3 Core") + " - ";
#ifdef ENABLE_WALLET
...
{  QActionGroup* tabGroup = new QActionGroup(this);
    ...
    mainIcon = new QWidget();
    mainIcon->setMinimumHeight(100);
    mainIcon->setStyleSheet("background-image: url(':/images/soyuz3_logo_main');\
                             background-repeat: no-repeat;\
                             background-position: center center;");//':/images/soyuz3_logo_main
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SOYUZ3 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and soyuz3: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSYZ"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SOYUZ3 Core"), this);
    aboutAction->setStatusTip(tr("Show information about SOYUZ3 Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for SOYUZ3"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SOYUZ3 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SOYUZ3 addresses"));
    ...
    openAction->setStatusTip(tr("Open a SOYUZ3: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SOYUZ3 Core help message to get a list with possible SOYUZ3 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Soyuz3 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Soyuz3 network", "", count));
}
...
{
    QString strTitle = tr("Soyuz3 Core"); // default title
