...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SYZ);
    ...
    if (!settings.contains("nAnonymizeSoyuz3Amount"))
        settings.setValue("nAnonymizeSoyuz3Amount", 1000);

    nAnonymizeSoyuz3Amount = settings.value("nAnonymizeSoyuz3Amount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeSoyuz3Amount"))
        SoftSetArg("-anonymizesoyuz3amount", settings.value("nAnonymizeSoyuz3Amount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in soyuz3.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeSoyuz3Amount:
            return QVariant(nAnonymizeSoyuz3Amount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizeSoyuz3Amount:
            nAnonymizeSoyuz3Amount = value.toInt();
            settings.setValue("nAnonymizeSoyuz3Amount", nAnonymizeSoyuz3Amount);
            emit anonymizeSoyuz3AmountChanged(nAnonymizeSoyuz3Amount);
            break;
        case CoinControlFeatures:
