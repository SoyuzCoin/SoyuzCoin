...
/* Soyuz3 GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Soyuz3"
#define QAPP_ORG_DOMAIN "soyuz3.cc"
#define QAPP_APP_NAME_DEFAULT "Soyuz3-Qt"
#define QAPP_APP_NAME_TESTNET "Soyuz3-Qt-testnet"
