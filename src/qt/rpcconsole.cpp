                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSYZPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzSYZPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzSYZPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSYZPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Soyuz3 RPC console.") + "<br>" +
