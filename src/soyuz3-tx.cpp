...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Soyuz3 Core soyuz3-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  soyuz3-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded soyuz3 transaction") + "\n" +
                               "  soyuz3-tx [options] -create [commands]   " + _("Create hex-encoded soyuz3 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded soyuz3 transaction
