...
#ifndef Soyuz3_STAKEINPUT_H
#define Soyuz3_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZSYZ() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zSYZStake can take two forms
...
public:
    ...
    bool IsZSYZ() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZSYZ() override { return false; }
};


#endif //Soyuz3_STAKEINPUT_H
