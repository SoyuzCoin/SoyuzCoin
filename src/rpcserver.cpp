...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Soyuz3 features */
        {"soyuz3", "masternode", &masternode, true, true, false},
        {"soyuz3", "listmasternodes", &listmasternodes, true, true, false},
        {"soyuz3", "getmasternodecount", &getmasternodecount, true, true, false},
        {"soyuz3", "masternodeconnect", &masternodeconnect, true, true, false},
        {"soyuz3", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"soyuz3", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"soyuz3", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"soyuz3", "masternodecurrent", &masternodecurrent, true, true, false},
        {"soyuz3", "masternodedebug", &masternodedebug, true, true, false},
        {"soyuz3", "startmasternode", &startmasternode, true, true, false},
        {"soyuz3", "createmasternodekey", &createmasternodekey, true, true, false},
        {"soyuz3", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"soyuz3", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"soyuz3", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"soyuz3", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"soyuz3", "getmasternodescores", &getmasternodescores, true, true, false},
        {"soyuz3", "mnbudget", &mnbudget, true, true, false},
        {"soyuz3", "preparebudget", &preparebudget, true, true, false},
        {"soyuz3", "submitbudget", &submitbudget, true, true, false},
        {"soyuz3", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"soyuz3", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"soyuz3", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"soyuz3", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"soyuz3", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"soyuz3", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"soyuz3", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"soyuz3", "checkbudgets", &checkbudgets, true, true, false},
        {"soyuz3", "mnsync", &mnsync, true, true, false},
        {"soyuz3", "spork", &spork, true, true, false},
        {"soyuz3", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> soyuz3-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31918/\n";
}
